...
const lowercaseArray = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", 
  "k", "l", "m", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z"]

// 26 characters of uppercase
const uppercaseArray = ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", 
...
function writePassword() {
  ...
  while (lowercases === false && uppercases === false && numbers === false && specialCharacters === false) {
